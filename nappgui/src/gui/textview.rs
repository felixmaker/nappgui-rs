...
use nappgui_sys::{
    textview_OnFilter, textview_OnFocus, textview_afspace, textview_apply_all, textview_apply_select, textview_bfspace,
    textview_bgcolor, textview_clear, textview_color, textview_copy, textview_cpos_writef, textview_create,
    textview_cut, textview_del_select, textview_editable, textview_family, textview_fsize, textview_fstyle,
    textview_get_text, textview_halign, textview_lspacing, textview_paste, textview_rtf, textview_scroll_caret,
    textview_scroll_visible, textview_select, textview_show_select, textview_size, textview_units, textview_wrap,
...
impl TextView {
    ...
    pub fn current_position_write(&self, text: &str) {
        let text = std::ffi::CString::new(text).unwrap();
        unsafe {
    ...
    pub fn set_rtf(&self, text: &Stream) {
        unsafe {
    ...
    /// Sets the text units.
    pub fn set_units(&self, units: u32) {
    ...
    pub fn set_font_style(&self, style: FontStyle) {
        unsafe {
            textview_fstyle(self.as_ptr(), style.bits());
        }
    }
    ...
    pub fn set_horizontal_align(&self, align: Align) {
        unsafe {
    ...
    pub fn set_line_spacing(&self, spacing: f32) {
        unsafe {
    ...
    pub fn set_before_space(&self, space: f32) {
        unsafe {
    ...
    pub fn set_after_space(&self, space: f32) {
        unsafe {
    ...
    pub fn set_show_select(&self, show: bool) {
        unsafe {
